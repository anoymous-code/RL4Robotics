...
<div class="stat-card" markdown><span class="num">2</span><span class="label">目标任务</span></div>
<div class="stat-card" markdown><span class="num">0</span><span class="label">已采集演示数据条数</span></div>
</div>
